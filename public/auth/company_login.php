        ...
        <div class="row justify-content-center py-4">
            <div class="col-sm-10 col-md-7 col-lg-5 col-xl-4">
                <div class="text-center mb-4">
                    <i class="bi bi-building" style="font-size: 3rem; color: var(--bs-primary);"></i>
                    <div class="brand h3 mb-1 mt-2">Sistema de Escalação</div>
                    <div class="text-muted">Acesse sua conta (Empresa)</div>
                </div>
                <div class="card login-card">
                    <div class="card-body p-4">
                        <h1 class="h5 mb-3 text-center"><i class="bi bi-box-arrow-in-right me-2"></i>Entrar como Empresa</h1>
                        <form action="/sistema_escalacao/public/auth/company_login_handler.php" method="post" class="needs-validation" novalidate>
                            ...
                            <div class="mb-3">
                                <label class="form-label"><i class="bi bi-lock me-1"></i>Senha</label>
                        ...
                        <div class="d-grid gap-2">
                            ...
                            <a href="/sistema_escalacao/public/auth/login.php" class="btn btn-outline-secondary">
                                <i class="bi bi-arrow-left me-2"></i>Voltar ao login geral
                            </a>
                        </div>
                    </div>
                </div>
